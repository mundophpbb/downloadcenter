...
class v_1_0_0 extends \phpbb\db\migration\migration
{
            ...
            'add_tables' => [
                ...
                $this->table_prefix . 'downloadcenter_items' => [
                    'COLUMNS' => [
                        ...
                        'user_id'         => ['UINT', 0],
                        'topic_id'        => ['UINT', 0],
                        'item_current_version_id' => ['UINT', 0],
                        'item_name'       => ['VCHAR:255', ''],
                        'item_slug'       => ['VCHAR:255', ''],
                    ...
                    'KEYS' => [
                        ...
                        'current_version_id' => ['INDEX', 'item_current_version_id'],
    ...
    {
        return [
            ['config.add', ['mundophpbb_downloadcenter_version', '1.0.99']],
            ...
            ['config.add', ['mundophpbb_downloadcenter_permission_mode', 'global']],
            ['config.add', ['mundophpbb_downloadcenter_show_public_stats', 1]],
            ['config.add', ['mundophpbb_downloadcenter_feed_enabled', 1]],
            ['config.add', ['mundophpbb_downloadcenter_rate_limit_count', 0]],
            ['config.add', ['mundophpbb_downloadcenter_rate_limit_window', 60]],
